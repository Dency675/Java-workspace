...
public class AccountUtility {
	...
	public static void main(String[] args) {
		...
		char goToMainMenu;
		do {
			System.out.println("1. Create Account 2. Display All Account 3.Display an Account 4. Create Customer 5. Display All Customer");
...
//				accountList.add(account);
			...
			case 5:
				...
				break;
			case 6:
				CustomerService.searchAccount(customerList);
				break;
			}
