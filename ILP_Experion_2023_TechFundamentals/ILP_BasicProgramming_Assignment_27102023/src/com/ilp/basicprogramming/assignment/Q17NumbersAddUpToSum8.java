...
public class Q17NumbersAddUpToSum8 {
	...
	public static void main(String[] args) {
		...
		int sum = 0;
		int temp1, temp2;
		System.out.println("Possible combination of numbers that are add up to sum 8 are : ");
		for (int index = 0; index < numberArray.length; index++) {
...
//						if((sum + numberArray[index2]) == 8)
//							System.out.println(temp1 + " + " + numberArray[index2] + " = " + (sum + numberArray[index2]));
//						
						System.out.println(temp1 + " + " + numberArray[index2] + " = " + (sum + numberArray[index2]));
...
//								if(sum == 8)
//									System.out.println(temp1 + " + " + temp2 + " + " + numberArray[index3] + " = " + sum);
								System.out.println(temp1 + " + " + temp2 + " + " + numberArray[index3] + " = " + sum);
